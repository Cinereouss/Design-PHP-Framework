<div class="container-fluid">
    <div class="dashboard-container">
        ...
        <table class="table table-striped">
            ...
            <tr>
                <td>
                    <p style="text-align:justify"><span style="font-size:14px"><strong>Fretboard Radius</strong></span>
                    </p>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <p style="text-align:justify"><span style="font-size:14px">&nbsp;D'Addario EXL</span></p>
                </td>
            </tr>
            </tbody>
        </table>
